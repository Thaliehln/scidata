...
\hypersetup{
  pdftitle={Demo aft format to use as template},
...
\end{abstract}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, borderline west={3pt}{0pt}{shadecolor}, interior hidden, frame hidden, sharp corners, boxrule=0pt, breakable]}{\end{tcolorbox}}\fi
